...
export function Modal({ isOpen, onClose, title, children, maxWidth = "max-w-2xl" }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center md:p-4 lg:p-6">
      ...
      <div className={`relative w-full ${maxWidth} bg-card md:border md:border-border h-full md:h-auto rounded-none md:rounded-xl shadow-2xl flex flex-col max-h-[100vh] md:max-h-[90vh] overflow-hidden`}>
